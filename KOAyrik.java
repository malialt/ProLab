...
//        farkli();
    ...
    public String bul(int numara)
    {
        ...
        return liste[kareOrtasý].toString() + "    " + islemSayaci + " hamlede dosya oluþturuldu, " + (islemSayaci2) + " hamlede arama iþlemi yapýldý.";
    }
    ...
    public void hepsini()
    {
        ...
        System.out.println("Tüm öðrencilerin Kare Ortasý Ayrýk Taþma ile aranmasý " + genelSayac + " arama iþlemi yapýldý." +
