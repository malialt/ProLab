...
{   
    ...
    public void txtYaz()
    {
        try
        {
            File dosya = new File("KOLineer.txt");
            ...
            {
                yazici.write( i + ". " + ogr.ogrNoAl() + " " + ogr.adAl() + " " + ogr.soyadAl() + "\r\n" );
                i++;
                islemSayaci++;
            }
    ...
    public void hepsini()
    {
        ...
        System.out.println("Tüm öðrencilerin Kare Ortasý Lineer yoklama ile aranmasý " + genelSayac + " arama iþlemi yapýldý." +
