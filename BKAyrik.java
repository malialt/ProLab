...
public class BKAyrik
{
    ...
    public String bul(int numara)
    {
        ...
        else if(liste[mod].ogrNoAl() != numara)
        {
            ...
            if(ayrikListe[i] != null)
                return "Ayrýk Liste : " + ayrikListe[i].toString() + "   " + islemSayaci + " hamlede dosya oluþturuldu, " + (islemSayaci2) + " hamlede arama iþlemi yapýldý.";
            return "Aradýðýnýz öðrenci bulunmamaktadýr. " + islemSayaci + " hamlede dosya oluþturuldu, " + (islemSayaci2) + " hamlede arama iþlemi yapýldý.";
        }
        //Bulunan noktada öðrenciyi ad soyad olarak döndürme
        return liste[mod].toString()+ "   " + islemSayaci + " hamlede dosya oluþturuldu, " + (islemSayaci2) + " hamlede arama iþlemi yapýldý.";
    }
    ...
    public void hepsini()
    {
        ...
        System.out.println("Tüm öðrencilerin Bölen-Kalan Ayrýk Taþma ile aranmasý " + genelSayac + " arama iþlemi yapýldý." +
